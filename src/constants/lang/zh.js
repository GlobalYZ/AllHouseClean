...
const zh = {
  ...
  MoveItems: [
    {
      title: "埃德蒙顿市中心 – 一居室豪华公寓退租清洁",
      description: [
        "这个最近的项目位于埃德蒙顿市中心的The Legends Private Residences。该单元是一套现代化的一居室一卫公寓，配备高端装修和电器。",
        "租客刚刚搬出，留下了明显的污垢和杂物。房主要求将空间恢复到原始的入住状态。我们的团队进行了详细的从上到下的清洁，以满足这一期望。",
      ],
      dotpoints: [
        "厨房：所有表面、橱柜和电器（包括冰箱、烤箱和微波炉）都进行了内外彻底清洁。",
        "浴室：浴缸、马桶、水槽和瓷砖都进行了擦洗和消毒，使每个表面都焕然一新、一尘不染。",
        "客厅和卧室：地板吸尘和拖地，清除所有角落的灰尘，家具焕然一新，呈现出温馨的外观。",
        "洗衣区：清洁洗衣机和烘干机，确保空间整洁且随时可用。",
        "最后润色：窗户、固定装置和高接触区域都进行了抛光，达到如新的效果。",
      ],
    },
  ],
  description: {
